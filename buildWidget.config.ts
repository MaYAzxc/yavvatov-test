...
function processStyles() {
    fs.copyFileSync("./src/library/WeatherWidget/weather-widget.scss", "./dist/weather-widget.scss");
    const compileResult = compile("./dist/weather-widget.scss", { sourceMap: false });
    fs.writeFileSync("./dist/weather-widget.css", compileResult.css);
}
